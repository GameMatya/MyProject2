...
void DebugRenderer::Render(ID3D11DeviceContext* context, const DirectX::XMFLOAT4X4& view, const DirectX::XMFLOAT4X4& projection)
{
  ...
  // 定数バッファ設定
  context->VSSetConstantBuffers(12, 1, constantBuffer.GetAddressOf());
  ...
  {
    DirectX::XMFLOAT3 Pos = square.center;
    DirectX::XMFLOAT3 Size = square.radius;
...
// 四角描画
void DebugRenderer::DrawSquare(const DirectX::XMFLOAT3& center, const DirectX::XMFLOAT3& radius, const DirectX::XMFLOAT4& color)
{
  Square square;
