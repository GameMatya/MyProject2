...
#include "Sprite3D_Default.h"

Sprite3D_Default::Sprite3D_Default(ID3D11Device* device)
{
  // 頂点シェーダー
  {
    // ファイルを開く
    FILE* fp = nullptr;
    fopen_s(&fp, "Shader\\Sprite3D_Default_VS.cso", "rb");
  ...
  // ピクセルシェーダー
  {
    // ファイルを開く
    FILE* fp = nullptr;
    fopen_s(&fp, "Shader\\Sprite3D_Default_PS.cso", "rb");
    _ASSERT_EXPR_A(fp, "CSO File not found");
...
// 描画開始
void Sprite3D_Default::Begin(ID3D11DeviceContext* dc, const RenderContext& rc)
{
  // Shader設定
...
// 描画
void Sprite3D_Default::Draw(ID3D11DeviceContext* dc, const Sprite3D* sprite, const DirectX::XMFLOAT4& color)
{
...
// 描画終了
void Sprite3D_Default::End(ID3D11DeviceContext* dc)
{
