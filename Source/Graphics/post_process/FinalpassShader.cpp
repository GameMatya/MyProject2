...
#include "Graphics/post_process/FinalpassShader.h"
...
// 描画開始
void FinalpassShader::Begin(ID3D11DeviceContext* deviceContext, const RenderContext& rc)
{
...
// 描画
void FinalpassShader::Draw(ID3D11DeviceContext* deviceContext, const RenderContext& rc, const Sprite* sprite)
{
...
// 描画終了
void FinalpassShader::End(ID3D11DeviceContext* deviceContext)
{
